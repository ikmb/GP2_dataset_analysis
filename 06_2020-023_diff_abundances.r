...
rg_stool <- subset(rg_stool, select = -c(Material, Group, Combined))
...
write.csv(tab_zero, file = "./results/2020-023_tab_zero_stool.csv", row.names = TRUE)

res_prim  <-  output$res
write.csv(res_prim, file = "./results/2020-023_res_prim_stool.csv", row.names = TRUE)

res_global  <-  output$res_global
write.csv(res_global , file = "./results/2020-023_res_global_stool.csv", row.names = TRUE)

res_pair  <-  output$res_pair
write.csv(res_pair, file = "./results/2020-023_res_pair_stool.csv", row.names = TRUE)

res_dunn  <-  output$res_dunn
write.csv(res_dunn, file = "./results/2020-023_res_dunn_stool.csv", row.names = TRUE)

res_trend  <-  output$res_trend
write.csv(res_trend, file = "./results/2020-023_res_trend_stool.csv", row.names = TRUE)